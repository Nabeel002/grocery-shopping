...
<body>
  ...
  <div class="div-center">
    ...
    <div class="content">
      ...
      <h3>Login</h3>
      <hr />
      <form action="./database/validation.php" method="POST">
        <div class="form-group">
          <label for="username">Username</label>
          <input type="name"  name="user"class="form-control" id="password" placeholder="Username">
        </div>
        <div class="form-group">
        ...
        <hr />
        <a href="sign-up.php"> <button type="button" class="btn btn-link" >Signup</button></a>
